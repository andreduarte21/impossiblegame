...
public class TextRun implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            RunningTxt rtIntroLine1 = new RunningTxt(introLine1, initX, 180);
            rtIntroLine1.roll();
            try {
                Thread.sleep(200);
            } catch (InterruptedException e) {
            ...
            RunningTxt rtIntroLine2 = new RunningTxt(introLine2, initX, 230);
            rtIntroLine2.roll();
            try {
                Thread.sleep(200);
            } catch (InterruptedException e) {
            ...
            RunningTxt rtIntroLine3 = new RunningTxt(introLine3, initX, 260);
            rtIntroLine3.roll();
            try {
                Thread.sleep(200);
            } catch (InterruptedException e) {
            ...
            RunningTxt rtIntroLine4 = new RunningTxt(introLine4, initX, 290);
            rtIntroLine4.roll();
            try {
                Thread.sleep(200);
            } catch (InterruptedException e) {
            ...
            RunningTxt rtIntroLine5 = new RunningTxt(introLine5, initX, 320);
            rtIntroLine5.roll();
            try {
                Thread.sleep(200);
            } catch (InterruptedException e) {
            ...
            RunningTxt rtIntroLine6 = new RunningTxt(introLine6, initX, 350);
            rtIntroLine6.roll();
            try {
                Thread.sleep(200);
            } catch (InterruptedException e) {
            ...
            RunningTxt rtIntroLine7 = new RunningTxt(introLine7, initX, 380);
            rtIntroLine7.roll();
            try {
                Thread.sleep(200);
            } catch (InterruptedException e) {
            ...
            RunningTxt rtIntroLine8 = new RunningTxt(introLine8, initX, 410);
            rtIntroLine8.roll();
            try {
                Thread.sleep(200);
            } catch (InterruptedException e) {
            ...
            RunningTxt rtIntroLine9 = new RunningTxt(introLine9, initX, 440);
            rtIntroLine9.roll();
            try {
                Thread.sleep(200);
            } catch (InterruptedException e) {
            ...
            RunningTxt rtIntroLine10 = new RunningTxt(introLine10, initX, 470);
            rtIntroLine10.roll();
            try {
                Thread.sleep(2000);
            } catch (InterruptedException e) {
